//
//  ViewController.m
//  InAppPurchaseAutoRenewableSample
//
...
- (void)viewDidLoad {
    ...
    // プロダクト情報の問い合わせ
    [self appendLog:@"\n>プロダクト情報の問い合わせ"];
    NSArray *identifiers = @[@"jp.ne.sapporoworks.InAppPurchaseAutoRenewableSample.ProductId"];
...
- (void) purchased:(SKPaymentTransaction *)transaction {
    ...
    [[CargoBay sharedManager] verifyTransaction:transaction password:password success:^(NSDictionary *json) {
